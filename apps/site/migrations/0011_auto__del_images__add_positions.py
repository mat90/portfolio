...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'site_images')

        # Adding model 'Positions'
        db.create_table(u'site_positions', (
        ...
        db.send_create_signal(u'site', ['Positions'])


    def backwards(self, orm):
        # Adding model 'Images'
        db.create_table(u'site_images', (
            ('content', self.gf('django.db.models.fields.related.ForeignKey')(related_name='image', to=orm['site.Content'])),
            ('text', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'site', ['Images'])

        # Deleting model 'Positions'
        db.delete_table(u'site_positions')
